...
<div class="page-header page-header-light">
    <div class="page-header-content header-elements-md-inline">
        ...
        <div class="d-flex justify-content-center">
            <a href="{{route('testimonials.create')}}" class="btn btn-success btn-labeled btn-labeled-left btn-lg legitRipple"><b><i class="icon-pin-alt"></i></b>{{ __('admin.testimonial_create_button_label') }}
            </a>
            ...
            @if($testimonials)
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <th>{{ __('admin.testimonial_th1') }}</th>
                        <th>{{ __('admin.pages_th2') }}</th>
                        <th>{{ __('admin.pages_th4') }}</th>
                        <th>{{ __('admin.testimonial_th2') }}</th>
                        <th>Action</th>
                    ...
                    @foreach($testimonials as $testimonial)
                        <tr>
                            ...
                            <td>
                                <a href="{{route('testimonials.edit',['page'=>$testimonial->id])}}"
                                ...
                                <a data-app-id="{{$testimonial->id}}" href="{{route('testimonials.destroy',['testimonial'=>$testimonial->id])}}"
